 ...
 */
public class EntityArditeBossSpawner extends EntityThrowable {

    public EntityArditeBossSpawner(World world) {
        super(world);
    }

    public EntityArditeBossSpawner(World world, EntityLivingBase elb) {
        super(world, elb);
    }

    public EntityArditeBossSpawner(World world, double x, double y, double z) {
        super(world, x, y, z);
    }
    ...
    protected void onImpact(MovingObjectPosition mop) {
        ...
        if (!this.worldObj.isRemote) {
            EntityArditeBoss entity = new EntityArditeBoss(this.worldObj);
