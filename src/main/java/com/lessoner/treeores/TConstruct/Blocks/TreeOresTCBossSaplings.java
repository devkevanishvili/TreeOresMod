...
import com.lessoner.treeores.TConstruct.WorldGen.WorldGenTCBossTreeOres;
 ...
 */
public class TreeOresTCBossSaplings extends BlockSapling {
    private static final IIcon[] I_ICONS = new IIcon[TreeOresTCLogs.types.length];

    protected TreeOresTCBossSaplings() {
        float f = 0.4F;
    ...
    public IIcon getIcon(int side, int meta) {
        meta &= 7;
        return I_ICONS[MathHelper.clamp_int(meta, 0, 1)];
    }
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTCBossTreeOres(TreeOresTCBlocks.TreeOresTCLogs, TreeOresTCBlocks.TreeOresTCLeaves, 0, 0, false, 15, 7, false);

                break;
            case 1:
                object = new WorldGenTCBossTreeOres(TreeOresTCBlocks.TreeOresTCLogs, TreeOresTCBlocks.TreeOresTCLeaves, 1, 1, false, 15, 7, false);
