 ...
 */
public class TreeOresTCSaplings extends BlockSapling {
    private static final IIcon[] I_ICONS = new IIcon[TreeOresTCLogs.types.length];

    protected TreeOresTCSaplings() {
        float f = 0.4F;
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTCTreeOres(TreeOresTCBlocks.TreeOresTCLogs, TreeOresTCBlocks.TreeOresTCLeaves, 0, 0, false, 4, 5, false);

                break;
            case 1:
                object = new WorldGenTCTreeOres(TreeOresTCBlocks.TreeOresTCLogs, TreeOresTCBlocks.TreeOresTCLeaves, 1, 1, false, 4, 5, false);
