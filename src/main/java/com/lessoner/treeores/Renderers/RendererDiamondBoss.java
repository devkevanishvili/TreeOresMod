...
public class RendererDiamondBoss
        extends RenderBiped {
    public static final ResourceLocation texture = new ResourceLocation(References.diamondBossTexture);
    ...
    public void renderDiamondBoss(EntityDiamondBoss entity, double x, double y, double z, float u, float v) {
