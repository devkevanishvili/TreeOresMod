...
import com.lessoner.treeores.Thaumcraft.WorldGen.WorldGenTreeOresBossTHC1;
 ...
 */
public class TreeOresTHCBossSaplings1 extends BlockSapling {
    private static final IIcon[] I_ICONS = new IIcon[TreeOresTHCLogs1.types.length];

    protected TreeOresTHCBossSaplings1() {
        float f = 0.4F;
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOresBossTHC1(TreeOresTHCBlocks.TreeOresTHCLogs1, TreeOresTHCBlocks.TreeOresTHCBossLeaves1, 0, 0, false, 15, 7, false);

                break;
            case 1:
                object = new WorldGenTreeOresBossTHC1(TreeOresTHCBlocks.TreeOresTHCLogs1, TreeOresTHCBlocks.TreeOresTHCBossLeaves1, 1, 1, false, 15, 7, false);

                break;
            case 2:
                object = new WorldGenTreeOresBossTHC1(TreeOresTHCBlocks.TreeOresTHCLogs1, TreeOresTHCBlocks.TreeOresTHCBossLeaves1, 2, 2, false, 15, 7, false);

                break;
            case 3:
                object = new WorldGenTreeOresBossTHC1(TreeOresTHCBlocks.TreeOresTHCLogs1, TreeOresTHCBlocks.TreeOresTHCBossLeaves1, 3, 3, false, 15, 7, false);
