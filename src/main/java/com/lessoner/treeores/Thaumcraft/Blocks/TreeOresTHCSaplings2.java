...
import com.lessoner.treeores.Thaumcraft.WorldGen.WorldGenTreeOresTHC2;
 ...
 */
public class TreeOresTHCSaplings2 extends BlockSapling {
    private static final IIcon[] I_ICONS = new IIcon[TreeOresTHCLogs2.types.length];

    protected TreeOresTHCSaplings2() {
        float f = 0.4F;
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOresTHC2(TreeOresTHCBlocks.TreeOresTHCLogs2, TreeOresTHCBlocks.TreeOresTHCLeaves2, 0, 0, false, 4, 5, false);

                break;
            case 1:
                object = new WorldGenTreeOresTHC2(TreeOresTHCBlocks.TreeOresTHCLogs2, TreeOresTHCBlocks.TreeOresTHCLeaves2, 1, 1, false, 4, 5, false);

                break;
            case 2:
                object = new WorldGenTreeOresTHC2(TreeOresTHCBlocks.TreeOresTHCLogs2, TreeOresTHCBlocks.TreeOresTHCLeaves2, 2, 2, false, 4, 5, false);

                break;
            case 3:
                object = new WorldGenTreeOresTHC2(TreeOresTHCBlocks.TreeOresTHCLogs2, TreeOresTHCBlocks.TreeOresTHCLeaves2, 3, 3, false, 4, 5, false);
