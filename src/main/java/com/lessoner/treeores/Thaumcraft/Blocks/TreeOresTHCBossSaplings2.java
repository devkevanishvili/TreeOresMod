...
import com.lessoner.treeores.Thaumcraft.WorldGen.WorldGenTreeOresBossTHC2;
 ...
 */
public class TreeOresTHCBossSaplings2 extends BlockSapling {
    private static final IIcon[] I_ICONS = new IIcon[TreeOresTHCLogs2.types.length];

    protected TreeOresTHCBossSaplings2() {
        float f = 0.4F;
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOresBossTHC2(TreeOresTHCBlocks.TreeOresTHCLogs2, TreeOresTHCBlocks.TreeOresTHCBossLeaves2, 0, 0, false, 15, 7, false);

                break;
            case 1:
                object = new WorldGenTreeOresBossTHC2(TreeOresTHCBlocks.TreeOresTHCLogs2, TreeOresTHCBlocks.TreeOresTHCBossLeaves2, 1, 1, false, 15, 7, false);

                break;
            case 2:
                object = new WorldGenTreeOresBossTHC2(TreeOresTHCBlocks.TreeOresTHCLogs2, TreeOresTHCBlocks.TreeOresTHCBossLeaves2, 2, 2, false, 15, 7, false);

                break;
            case 3:
                object = new WorldGenTreeOresBossTHC2(TreeOresTHCBlocks.TreeOresTHCLogs2, TreeOresTHCBlocks.TreeOresTHCBossLeaves2, 3, 3, false, 15, 7, false);
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        for (int i = 0; i < I_ICONS.length; i++) {
            I_ICONS[i] = iconRegister.registerIcon(References.MODID + ":THC/" + this.getTextureName() + "_" + TreeOresTHCLogs2.types[i]);
        }
    }
