...
public class TreeOresBossSaplings2 extends BlockSapling {
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOres2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresBossLeaves2, 0, 0, false, 15, 7, false);

                break;
            case 1:
                object = new WorldGenTreeOres2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresBossLeaves2, 1, 1, false, 15, 7, false);

                break;
            case 2:
                object = new WorldGenTreeOres2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresBossLeaves2, 2, 2, false, 15, 7, false);

                break;
            case 3:
                object = new WorldGenTreeOres2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresBossLeaves2, 3, 3, false, 15, 7, false);
