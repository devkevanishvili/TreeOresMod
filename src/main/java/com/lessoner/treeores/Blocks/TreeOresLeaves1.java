...
public class TreeOresLeaves1 extends BlockOldLeaf {
    public static final String[][] leaf_types = new String[][]{{"tleaves1_iron", "tleaves1_gold", "tleaves1_coal", "tleaves1_redstone"}, {"tleaves1_iron_opaque", "tleaves1_gold_opaque", "tleaves1_coal_opaque", "tleaves1_redstone_opaque"}};
