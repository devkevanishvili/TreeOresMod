 ...
 */
public class TreeOresSaplings3 extends BlockSapling {
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOres3(TreeOresBlocks.TreeOresLogs3, TreeOresBlocks.TreeOresLeaves3, 0, 0, false, 4, 5, false);

                break;
            case 1:
                object = new WorldGenTreeOres3(TreeOresBlocks.TreeOresLogs3, TreeOresBlocks.TreeOresLeaves3, 1, 1, false, 4, 5, false);

                break;
            case 2:
                object = new WorldGenTreeOres3(TreeOresBlocks.TreeOresLogs3, TreeOresBlocks.TreeOresLeaves3, 2, 2, false, 4, 5, false);
