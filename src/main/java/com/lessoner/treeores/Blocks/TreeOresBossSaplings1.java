...
public class TreeOresBossSaplings1 extends BlockSapling {
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOres1(TreeOresBlocks.TreeOresLogs1, TreeOresBlocks.TreeOresBossLeaves1, 0, 0, false, 15, 7, false);

                break;
            case 1:
                object = new WorldGenTreeOres1(TreeOresBlocks.TreeOresLogs1, TreeOresBlocks.TreeOresBossLeaves1, 1, 1, false, 15, 7, false);

                break;
            case 2:
                object = new WorldGenTreeOres1(TreeOresBlocks.TreeOresLogs1, TreeOresBlocks.TreeOresBossLeaves1, 2, 2, false, 15, 7, false);

                break;
            case 3:
                object = new WorldGenTreeOres1(TreeOresBlocks.TreeOresLogs1, TreeOresBlocks.TreeOresBossLeaves1, 3, 3, false, 15, 7, false);
