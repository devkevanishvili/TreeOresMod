 ...
 */
public class TreeOresSaplings2 extends BlockSapling {
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOres2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresLeaves2, 0, 0, false, 4, 5, false);

                break;
            case 1:
                object = new WorldGenTreeOres2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresLeaves2, 1, 1, false, 4, 5, false);

                break;
            case 2:
                object = new WorldGenTreeOres2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresLeaves2, 2, 2, false, 4, 5, false);

                break;
            case 3:
                object = new WorldGenTreeOres2(TreeOresBlocks.TreeOresLogs2, TreeOresBlocks.TreeOresLeaves2, 3, 3, false, 4, 5, false);
