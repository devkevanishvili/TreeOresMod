...
public class EntityGlowstoneBossSpawner extends EntityThrowable {
    ...
    public EntityGlowstoneBossSpawner(World world) {
        super(world);
    }

    public EntityGlowstoneBossSpawner(World world, EntityLivingBase elb) {
        super(world, elb);
    }

    public EntityGlowstoneBossSpawner(World world, double x, double y, double z) {
        super(world, x, y, z);
    }
