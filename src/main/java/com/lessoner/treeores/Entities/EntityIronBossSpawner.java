...
public class EntityIronBossSpawner extends EntityThrowable {
    ...
    public EntityIronBossSpawner(World world) {
        super(world);
    }

    public EntityIronBossSpawner(World world, EntityLivingBase elb) {
        super(world, elb);
    }

    public EntityIronBossSpawner(World world, double x, double y, double z) {
        super(world, x, y, z);
    }
