...
public class EntityCoalBossSpawner extends EntityThrowable {
    ...
    public EntityCoalBossSpawner(World world) {
        super(world);
    }

    public EntityCoalBossSpawner(World world, EntityLivingBase elb) {
        super(world, elb);
    }

    public EntityCoalBossSpawner(World world, double x, double y, double z) {
        super(world, x, y, z);
    }
