package com.lessoner.treeores.IC2.WorldGen;
 ...
 */
public class WorldGenTreeOresIC2Boss extends WorldGenAbstractTree {
    ...
    public WorldGenTreeOresIC2Boss(Block wood, Block leaves, int metaWood, int metaLeaves) {
        this(wood, leaves, metaWood, metaLeaves, false, 4, 3, false);
    }

    public WorldGenTreeOresIC2Boss(Block wood, Block leaves, int metaWood, int metaLeaves, boolean doBlockNotify, int minTreeHeight, int randomTreeHeight, boolean vinesGrow) {
        super(doBlockNotify);
    ...
    public boolean generate(World world, Random random, int x, int y, int z) {
        ...
        if ((y >= 1) && (y + l + 1 <= 256)) {
            ...
            boolean isSoil = block2.canSustainPlant(world, x, y - 1, z, ForgeDirection.UP, (BlockSapling) TreeOresIC2Blocks.TreeOresIC2BossSaplings);
            if ((isSoil) && (y < 256 - l - 1)) {
                        ...
                        for (int k2 = z - l1; k2 <= z + l1; k2++) {
                            ...
                            if ((Math.abs(j2) != l1) || (Math.abs(l2) != l1) || ((random.nextInt(2) != 0) && (i3 != 0))) {
                                ...
                                if ((block1.isAir(world, i2, k1, k2)) || (block1.isLeaves(world, i2, k1, k2))) {
                                    setBlockAndNotifyAdequately(world, i2, k1, k2, TreeOresIC2Blocks.TreeOresIC2BossLeaves, this.metaLeaves);
                                }
                            }
                        }
                    }
                ...
                for (int k1 = 0; k1 < l; k1++) {
                    ...
                    if ((block.isAir(world, x, y + k1, z)) || (block.isLeaves(world, x, y + k1, z))) {
                        setBlockAndNotifyAdequately(world, x, y + k1, z, TreeOresIC2Blocks.TreeOresIC2Logs, this.metaWood);
