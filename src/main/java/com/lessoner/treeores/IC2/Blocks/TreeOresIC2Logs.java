 ...
 */
public class TreeOresIC2Logs extends BlockOldLog {
    public static final String[] types = new String[]{"copper", "tin", "uranium", "lead"};
    ...
    public Item getItemDropped(int i, Random random, int k) {
        if (References.enableChops) {
            return TreeOresIC2Items.TreeOresIC2Chops;
        } else {
