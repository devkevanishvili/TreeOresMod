...
import com.lessoner.treeores.IC2.WorldGen.WorldGenTreeOresIC2Boss;
 ...
 */
public class TreeOresIC2BossSaplings extends BlockSapling {
    private static final IIcon[] I_ICONS = new IIcon[TreeOresIC2Logs.types.length];

    protected TreeOresIC2BossSaplings() {
        float f = 0.4F;
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOresIC2Boss(TreeOresIC2Blocks.TreeOresIC2Logs, TreeOresIC2Blocks.TreeOresIC2BossLeaves, 0, 0, false, 15, 7, false);

                break;
            case 1:
                object = new WorldGenTreeOresIC2Boss(TreeOresIC2Blocks.TreeOresIC2Logs, TreeOresIC2Blocks.TreeOresIC2BossLeaves, 1, 1, false, 15, 7, false);

                break;
            case 2:
                object = new WorldGenTreeOresIC2Boss(TreeOresIC2Blocks.TreeOresIC2Logs, TreeOresIC2Blocks.TreeOresIC2BossLeaves, 2, 2, false, 15, 7, false);

                break;
            case 3:
                object = new WorldGenTreeOresIC2Boss(TreeOresIC2Blocks.TreeOresIC2Logs, TreeOresIC2Blocks.TreeOresIC2BossLeaves, 3, 3, false, 15, 7, false);

                break;
            case 4:
               /* if (TreeOres.diamondtree) {
                    object = new WorldGenDiamondTree(TreeOresIC2Blocks.TreeOresIC2Logs2, TreeOresIC2Blocks.TreeOresIC2Leaves2, 0, 0, false, 4, 8, false);
                }*/
                break;
            case 5:
              /*  if (TreeOres.emeraldtree) {
                    object = new WorldGenEmeraldTree(TreeOresIC2Blocks.TreeOresIC2Logs2, TreeOresIC2Blocks.TreeOresIC2Leaves2, 1, 1, false, 4, 8, false);
                }*/
                break;
            case 6:
                break;
