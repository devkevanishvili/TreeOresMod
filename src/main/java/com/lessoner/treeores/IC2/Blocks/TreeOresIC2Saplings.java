 ...
 */
public class TreeOresIC2Saplings extends BlockSapling{
    private static final IIcon[] I_ICONS = new IIcon[TreeOresIC2Logs.types.length];

    protected TreeOresIC2Saplings() {
        float f = 0.4F;
    ...
    public void func_149878_d(World w, int x, int y, int z, Random r) {
        ...
        switch (l) {
            case 0:
                object = new WorldGenTreeOresIC2(TreeOresIC2Blocks.TreeOresIC2Logs, TreeOresIC2Blocks.TreeOresIC2Leaves, 0, 0, false, 4, 5, false);

                break;
            case 1:
                object = new WorldGenTreeOresIC2(TreeOresIC2Blocks.TreeOresIC2Logs, TreeOresIC2Blocks.TreeOresIC2Leaves, 1, 1, false, 4, 5, false);

                break;
            case 2:
                object = new WorldGenTreeOresIC2(TreeOresIC2Blocks.TreeOresIC2Logs, TreeOresIC2Blocks.TreeOresIC2Leaves, 2, 2, false, 4, 5, false);

                break;
            case 3:
                object = new WorldGenTreeOresIC2(TreeOresIC2Blocks.TreeOresIC2Logs, TreeOresIC2Blocks.TreeOresIC2Leaves, 3, 3, false, 4, 5, false);
